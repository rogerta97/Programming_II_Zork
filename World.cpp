...
void world::CreateWorld(){
	...
	strcpy_s((char*)room[11].name, 50, "STICK CONTAINER ROOM");
	strcpy_s((char*)room[12].name, 50, "LONELY BATHTUB");
	strcpy_s((char*)room[13].name, 50, "EARTH CORRIDOR");
	strcpy_s((char*)room[14].name, 50, "MINE");
	strcpy_s((char*)room[15].name, 50, "BLACK HOLE");
	strcpy_s((char*)room[16].name, 50, "DRAWING ROOM");
	...
	strcpy_s((char*)room[6].description, 350, "Things don't make sense, now you entered to your old mum's room, lefting the entrance on south, on the north of the room there is a mirror with some make up and a fan, in the east there is the bed, but there are some weird scratches on the wall.\n");
	...
	strcpy_s((char*)room[10].description, 350, "You appered into an aquarium, you left the entrance on the west, you can see a fishbowl full of sharks on the north, on the east there is the same fishbowl than the one with sharks, but they are separated between a huge metalic wall.\n");
	strcpy_s((char*)room[11].description, 350, "There is a big container with sticks inside in the south of the room that seems to be needed for something, at the west the is a table full of buttons.\n");
	strcpy_s((char*)room[12].description, 350, "You are seen the exit of the bathroom on the east, and there is a bathtub on the north, something strange happens, you start to feel vibrations on the floor and something wakes up from the watter.\n");
	strcpy_s((char*)room[13].description, 350, "You are at the end of a corridor, there are 3 doors, one in each wall direction.\n");
	strcpy_s((char*)room[14].description, 350, "You entered and you suddently appear in a mine, the door is on the north and the wall on the south seems to be a little bit softer, east and weast walls are full of insects\n");				//This room will be dark at the begining, the player will need to light up something 
	...
	strcpy_s((char*)room[16].description, 350, "You entered to a drawing room with the walls made of stone, the exit is on the south and there is a human figure made of rock on the north of the room.\n");
	...
	strcpy_s((char*)room[2].help, 100, "Sometimes is good giving watter to your enemies.\n\n");
	...
	strcpy_s((char*)exit[11].name, 50, "container stick door");
	strcpy_s((char*)exit[12].name, 50, "lonely bathtub door");
	strcpy_s((char*)exit[13].name, 50, "earth corridor");
	strcpy_s((char*)exit[14].name, 50, "mine door");
	strcpy_s((char*)exit[15].name, 50, "black hole room door");
	strcpy_s((char*)exit[16].name, 50, "drawing room door");
